					...
					<div class="container box_1620">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item active"><a class="nav-link" href="HC.php">Hostel Council</a></li>
...
<h1 style="font-family:'Zilla slab',serif;font-size:40px;text-align:center;margin-top:200px;color:white">HOSTEL COUNCIL</h1><br>
<div class="column">
<h2>DESCRIPTION</h2>
<hr>
<p>
...
$sql="SELECT clubinfo FROM clubs WHERE clubid='HSCN'";
$result=$conn->query($sql);
$row = $result->fetch_assoc();
echo $row["clubinfo"];
?>
</p>
<img src="download.jpg" style="margin-left:200px;" alt="RAM" width="20%" height="50%">
<h2>RECENT EVENTS</h2>
<hr>
<?php
$sql = "SELECT poster FROM events WHERE clubid='HSCN' AND date_event>=CURDATE() ORDER BY date_event";
...
<pre>
<?php
$sql="SELECT faculty_advisor FROM clubs WHERE clubid='HSCN'";
$result=$conn->query($sql);
$row = $result->fetch_assoc();
...
<pre>
<?php
$sql = "SELECT secretary1,secretary2 FROM clubs WHERE clubid='HSCN'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
echo $row["secretary1"];
?>
...
<pre>
<?php
$sql="SELECT contact FROM clubs WHERE clubid='HSCN'";
$result=$conn->query($sql);
$row = $result->fetch_assoc();
echo $row["contact"];
?>
...
<?php
$sql="SELECT recr_link,message FROM events WHERE clubid='HSCN'";
$result=$conn->query($sql);
$row = $result->fetch_assoc();
