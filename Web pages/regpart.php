...
<a href="club-admin.php" class="active" style="border-bottom: 3px solid #6a0dad">Home - <?php $name=$_SESSION['username'];
echo $name;?></a>
...
<h1 style="font-size:40px; text-align:center;text-transform: uppercase">REGISTERED PARTICIPANTS - <?php echo $_GET['id']?></h1><br> 
<table id="table" border="none">
			...
			<tbody>
				<?php
					...
					$id=$_GET['id'];
					$sql1="select * from register where event='$id'";
