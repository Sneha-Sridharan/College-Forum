								...
								<!-- finally, using flex to create your layout -->
								 <div class="d-md-flex align-items-start justify-content-start">
								  ...
								  <div>
								   ...
								   <a class="dropdown-item active" href="ram.php">Ramanujan Association of Mathematics</a>
...
<h1 style="font-family:'Zilla slab',serif;font-size:40px;text-align:center;margin-top:200px;color:white">RAMANUJAN ASSOCIATION OF MATHEMATICS</h1><br>
<div class="column">
<h2>DESCRIPTION</h2>
<hr>
<p>
...
$sql="SELECT clubinfo FROM clubs WHERE clubid='RAMA'";
$result=$conn->query($sql);
$row = $result->fetch_assoc();
echo $row["clubinfo"];
?>
</p>
<img src="RAM.png" style="margin-left:200px;" hspace=100 alt="RAM" width="20%" height="50%">
<img src="RAM.jpg" alt="RAM" width="30%" height="50%"><br>
<h2>RECENT EVENTS</h2>
<hr>
<?php
$sql = "SELECT poster FROM events WHERE clubid='RAMA' AND date_event>=CURDATE() ORDER BY date_event";
...
<pre>
<?php
$sql="SELECT faculty_advisor FROM clubs WHERE clubid='RAMA'";
$result=$conn->query($sql);
$row = $result->fetch_assoc();
...
<pre>
<?php
$sql = "SELECT secretary1,secretary2 FROM clubs WHERE clubid='RAMA'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
echo $row["secretary1"];
?>
...
<pre>
<?php
$sql="SELECT contact FROM clubs WHERE clubid='RAMA'";
$result=$conn->query($sql);
$row = $result->fetch_assoc();
echo $row["contact"];
?>
...
<?php
$sql="SELECT recr_link,message FROM events WHERE clubid='RAMA'";
$result=$conn->query($sql);
$row = $result->fetch_assoc();
