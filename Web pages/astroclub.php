								...
								<!-- finally, using flex to create your layout -->
								 <div class="d-md-flex align-items-start justify-content-start">
								  ...
								  <div>
								   ...
								   <a class="dropdown-item active" href="astroclub.php">Astronomy Club</a>
...
<h1 style="font-family:'Zilla slab',serif;font-size:40px;text-align:center;margin-top:200px;color:white">ASTRONOMY CLUB</h1><br>
<div class="column">
<h2>DESCRIPTION</h2>
<hr>
<pre style="font-size:19.9px">
<?php
...
$sql="SELECT clubinfo FROM clubs WHERE clubid='ASTR'";
$result=$conn->query($sql);
$row = $result->fetch_assoc();
echo $row["clubinfo"];
?>
</pre>
<img src="astronomy.jpg" style="margin-left:100px;" alt="astronomy club" width="30%" height="50%"><br><br>
<h2>RECENT EVENTS</h2>
<hr>
<?php
$sql = "SELECT poster FROM events WHERE clubid='ASTR' AND date_event>=CURDATE() ORDER BY date_event";
...
<p>
<?php
$sql="SELECT faculty_advisor FROM clubs WHERE clubid='ASTR'";
$result=$conn->query($sql);
$row = $result->fetch_assoc();
...
<p>
<?php
$sql = "SELECT secretary1,secretary2 FROM clubs WHERE clubid='ASTR'";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
echo $row["secretary1"];
?>
...
<p>
<?php
$sql="SELECT contact FROM clubs WHERE clubid='ASTR'";
$result=$conn->query($sql);
$row = $result->fetch_assoc();
echo $row["contact"];
?>
...
<?php
$sql="SELECT recr_link,message FROM events WHERE clubid='ASTR'";
$result=$conn->query($sql);
$row = $result->fetch_assoc();
