...
echo $name;?></a>
  <a href="add_club.php" class="active">Add Club/Association</a>
  ...
  <a href="logout.php">Log out</a>
		...
		<div class="column right">
			<h1 style="text-align:center;font-size:40px;">ADD CLUB DETAILS</h1>
			<form class="reg-form" method="POST" action="add_club_test.php">
			<fieldset style="background:rgba(30,30,30,0.8)">
				ID 
				<input type="text" name="clubid" maxlength="4" required><br>
				Name
				<input type="text" name="clubname" required><br>
				Secretary 1
				<input type="text" name="secretary1" required><br>
				Secretary 2
				<input type="text" name="secretary2" required><br>
				Faculty Advisor
				<input type="text" name="facultyadvisor" required><br>
				Password
				<input type="password" name="password" required><br>
				Contact Number
				<input type="tel" name="contact" pattern="[0-9]{10}" required><br>
				Description<br>
				<textarea name="message" rows="15" cols="210"></textarea><br>
				<br>
