<?php
	...
	{	
		...
		unset($_SESSION['reset_pwd_stu_success']);
	}
	if(isset($_SESSION['login4_error']))
	{	
		echo '<script type="text/javascript">window.onload = function(){alert("Invalid username or password!")};</script>';
		unset($_SESSION['login4_error']);
	}
	if(isset($_SESSION['regerror']))
	{	
		echo '<script type="text/javascript">window.onload = function(){alert("Login to Register")};</script>';
...
<div class="column">
<h1 style="text-align:center;font-family:'Zilla slab',serif">STUDENT LOGIN</h1><br>
<form method="POST" action="logintest1.php">
Username 
<input type="text" name="username" required>
Password
<input type="password" name="password" required>
<br>
<br><a href="forgot_pwd_stu.php" id="forgot">Forgot Password?</a>
<br>
