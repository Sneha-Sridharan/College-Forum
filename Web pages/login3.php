...
<!-- your mega menu starts here! -->
								...
								<?php
									...
									echo "<li class='nav-item active'><a class='nav-link dropdown-toggle' href='#' id='loginDropdown' role='button' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>Login</a>
										...
										<a class='dropdown-item active' href='login3.php'>Main Admin Login</a>
										</div>
										</div>
										</div>
									</li>";
...
<div class="column">
<h1 style="text-align:center;font-family:'Zilla slab',serif;">MAIN ADMIN LOGIN</h1><br>
<form method="POST" action="logintestmain.php">
Username 
